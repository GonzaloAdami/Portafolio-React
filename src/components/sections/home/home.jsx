        ...
        <>
            <main id="section-home">
                <article className="container-data-skills">
                    <h1 className="title-data-skills">SKILLS</h1>
                    <p className="element-data-skills">JavaScript ECMAScript 2021</p>
                    <p className="element-data-skills">TypeScript 5.3</p>
                </article>

                <article className="container-data-framework">
                    <h1 className="title-data-framework">FRAMEWORK</h1>
                    <p className="element-data-framework">Angular 17</p>
                    <p className="element-data-framework">React 18.1</p>
                </article>

                <article className="container-data-database">
                    <h1 className="title-data-database">DATABASE</h1>
                    <p className="element-data-database">MySQL 8</p>                
                </article>

                <img src={pieza} alt="Reina" className="pieza" />
                <img src={planta} alt="planta" className="planta" />

                <article className="container-data-about">
